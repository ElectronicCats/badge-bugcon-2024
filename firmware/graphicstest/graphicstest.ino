...
void setup() {
  ...
  pinMode(5, OUTPUT);   // turn the LED on (HIGH is the voltage level)
  pinMode(2, OUTPUT);   // turn the LED on (HIGH is the voltage level)
  pinMode(11, OUTPUT);   // turn the LED on (HIGH is the voltage level)
  //COMS
  pinMode(15, OUTPUT);   // turn the LED on (HIGH is the voltage level)
  pinMode(23, OUTPUT);   // turn the LED on (HIGH is the voltage level)
  pinMode(1, OUTPUT);   // turn the LED on (HIGH is the voltage level)
  pinMode(10, OUTPUT);   // turn the LED on (HIGH is the voltage level)
  pinMode(22, OUTPUT);   // turn the LED on (HIGH is the voltage level)
