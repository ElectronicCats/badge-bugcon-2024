 ...
 * on an ESP32 microcontroller. It utilizes the microcontroller's GPIO and LEDC
 * functionalities to provide precise control over the color and brightness of
 * each LED. The library supports the configuration of each LED's color, as well
 * as enabling various lighting effects including blinking, transition, and
 * breathing effects, with customizable timing parameters. Each RGB LED can be
 * individually controlled, allowing for complex light effects across multiple
 * LEDs.
 *
 * @note This implementation is compatible with the ESP-IDF development
 * framework, version 5.0.2.
 *
 * @note This software is licensed under the Creative Commons
 * Attribution-NonCommercial-NoDerivatives 4.0 International License. To view a
 * copy of this license, visit
 * http://creativecommons.org/licenses/by-nc-nd/4.0/. You may not use,
 * distribute, modify, or sell this software without the express permission of
 * the author. For more information, please contact the author at
 * massimodallabona@gmail.com.
 */
